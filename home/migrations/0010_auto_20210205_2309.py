# Generated by Django 3.0.7 on 2021-02-05 22:09
...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.AddField(
            model_name='homepage',
            name='images',
            field=wagtail.core.fields.StreamField([('image', wagtail.images.blocks.ImageChooserBlock(required=True)), ('header', wagtail.core.blocks.CharBlock(help_text='Add your header', required=False)), ('text', wagtail.core.blocks.TextBlock(help_text='Add additional text', required=False)), ('internal_page', wagtail.core.blocks.PageChooserBlock(required=False))], null=True),
        ),
